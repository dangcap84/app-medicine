        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MedicineUnitId = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Medicines_MedicineUnits_MedicineUnitId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    UserId = table.Column<Guid>(type: "uuid", nullable: false),
                    ScheduleTimeId = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Notifications_ScheduleTimes_ScheduleTimeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Medicines_MedicineUnitId",
                table: "Medicines",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MedicineUnits_Name",
                table: "MedicineUnits",
                column: "Name",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Notifications_ScheduleTimeId",
                table: "Notifications",
